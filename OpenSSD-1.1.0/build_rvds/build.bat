...
armcc --via=armcc_opt.via -I..\ftl_%1 ..\issd\issd.c
if "%1" == "faster" (
	armcc --via=armcc_opt.via -I..\ftl_%1 ..\target_spw\shashtbl.c 
	armlink --via=armlink_opt.via init.o ftl.o sata_identify.o sata_cmd.o sata_isr.o sata_main.o sata_table.o mem_util.o flash.o flash_wrapper.o initialize.o misc.o uart.o tc_synth.o shashtbl.o issd.o
) else (
	armlink --via=armlink_opt.via init.o ftl.o sata_identify.o sata_cmd.o sata_isr.o sata_main.o sata_table.o mem_util.o flash.o flash_wrapper.o initialize.o misc.o uart.o tc_synth.o issd.o
)
