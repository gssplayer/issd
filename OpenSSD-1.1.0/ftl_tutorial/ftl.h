...
+ SCAN_LIST_BYTES + PAGE_MAP_BYTES + ISSD_CMD_BYTES + ISSD_WR_BUF_BYTES +  ISSD_COMPUTING_BYTES)
...
// issd for write/read cmd
#define ISSD_CMD_BUFFER_ADDR (PAGE_MAP_ADDR + PAGE_MAP_BYTES)
#define ISSD_CMD_BYTES BYTES_PER_PAGE

// issd write buffer
#define ISSD_WR_BUF_ADDR (ISSD_CMD_BUFFER_ADDR + ISSD_CMD_BYTES)
#define ISSD_WR_BUF_BYTES BYTES_PER_PAGE

// dram<->flash for issd
#define ISSD_COMPUTING_ADDR (ISSD_WR_BUF_ADDR + ISSD_WR_BUF_BYTES)
#define ISSD_CNT_PAGES 500
#define ISSD_CNT_SECTORS (ISSD_CNT_PAGES * SECTORS_PER_PAGE)
#define ISSD_COMPUTING_BYTES (ISSD_CNT_PAGES * BYTES_PER_PAGE)
///////////////////////////////
